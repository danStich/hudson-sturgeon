...
# Juveniles ----
# . Data read ----
# .. Previous data file (Stich et al. 2025 ----
juv_og <- read.csv("data/juv_haverstraw.csv") %>% 
  select(1:13)

juv_og <- juv_og %>%
  filter(!is.na(BATCH))

# .. Updated data file (years 2023-2025) ----
juv_haverstraw_2025 <- read.csv("data/juv_haverstraw_2025.csv")

# .. Merge ----
juv_haverstraw <- rbind(juv_og, juv_haverstraw_2025)


# . Results ----
# .. Load result file ----
load("results/juv_posts_poisson_itit_2025.rda")
...
adult_norrie_update <- read.csv("data/adult_norrie_update_2425.csv")
adult_norrie <- rbind(adult_norrie, adult_norrie_update)

adult_norrie <- adult_norrie %>%
  filter(!is.na(BATCH)) # Can filter out early years here


# . Results ----
# .. Load result file ----
load("results/adult_posts_poisson_itt_update.rda")
...
jpeg(filename = "results/FigureS1_update.jpg",
     res = 300,
...
# ... Plot ----
jpeg(filename = "results/Figure2_update.jpg",
     res = 300,
...
# .. Plot ----
jpeg(filename = "results/Figure3_update.jpg",
      res = 300,
